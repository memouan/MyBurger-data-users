      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5" >
            <!-- ************************** FORMULAIRE ******************************* -->
            <form action="../restaurant-css-framework/backoffice.php" method="post">
              ...
              <div class="form-group row">
                <div class="col-md-6 mr-auto">
                  <input name="submit" type="submit" class="btn btn-block btn-primary text-white py-3 px-5" value="Send Message">
                </div>
              </div>
            </form>
            <!-- ******************************** End Formulaire ******************* -->
